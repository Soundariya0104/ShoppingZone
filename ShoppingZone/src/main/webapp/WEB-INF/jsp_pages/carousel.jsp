			...
			<div class="active-slider">
				<div class="single-slider pos-rltv">
					<div class="slider-img">
						<img src="<c:url value="/resources/images/slider/slider01.jpeg"/>"
							alt="">
					</div>
				...
				<div class="single-slider pos-rltv">
					<div class="slider-img">
						<img
							src="<c:url value="/resources/images/slider/slider02.jpeg"/> "
							alt="">
					</div>
					<div class="slider-content pos-abs">
						<h4>Best Collection</h4>
				...
				<div class="single-slider pos-rltv">
					<div class="slider-img">
						<img src="<c:url value="/resources/images/slider/slider03.jpg"/>"
							alt="">
					</div>
					<div class="slider-content pos-abs">
						<h4>Best Collection</h4>
