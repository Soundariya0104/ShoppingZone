			...
			<div class="row">
				<div class="col-md-3 col-sm-6 col-xs-12">
					<div class="single-service shadow-box text-center">
						<img src="<c:url value="/resources/images/icons/garantee.png"/>"
							alt="">
				...
				<div class="col-md-3 col-sm-6 col-xs-12">
					<div class="single-service shadow-box text-center">
						<img src="<c:url value="/resources/images/icons/coupon.png"/>"
							alt="">
						<h5>Gift Coupon</h5>
					</div>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12">
					<div class="single-service shadow-box text-center">
						<img src="<c:url value="/resources/images/icons/delivery.png"/>"
							alt="">
						<h5>Free Shipping</h5>
					</div>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12">
					<div class="single-service shadow-box text-center">
						<img src="<c:url value="/resources/images/icons/support.png"/>"
							alt="">
						<h5>24x7 Support</h5>
					</div>
				</div>
