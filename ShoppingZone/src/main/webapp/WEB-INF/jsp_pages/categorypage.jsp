									...
									<li>
										<figure>
											...
											<figcaption>
												...
												<span class="aa-product-price"><i class="fa fa-inr"></i>
													${productList.productPrice }-/</span>
												<p class="aa-product-descrip">${productList.productDescription }</p>
												<a class="aa-add-card-btn" style="color: red"
													href="addtocart?username=${User}&productId=${productList.productId}&quantity=1"><span
													class="fa fa-shopping-cart"></span>Add To Cart</a>
											</figcaption>
										</figure>
										<div class="aa-product-hvr-content">
											<a href="#" data-toggle2="tooltip" data-placement="top"
												style="width: 50px;" title="Quick View" data-toggle="modal"
							...
							<div class="aa-recently-views">
								<ul>
									<li><a href="#" class="aa-cartbox-img"><img alt="img"
											src="<c:url value="/resources/images/product/07.jpg"/>"></a>
										<div class="aa-cartbox-info">
											<h4>
												<a href="#">Hockey Sticks</a>
											</h4>
											<p>
												<i class="fa fa-inr"></i>Rs.499
											</p>
										</div></li>
								</ul>
							</div>
