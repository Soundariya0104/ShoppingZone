...
<body ng-app="categoryTable" ng-controller="CategoryController">
								...
								<div class="aa-myaccount-register">
									...
									<c:choose>
										<c:when test="${ not empty values}">
											...
											<form:form action="addcategory" method="get"
												commandName="category">


												<label for="">Category Id:</label>
												<form:input type="text" value="${values.getCategoryId() }"
  ...
  width: 100%;" />
												...
												<form:input type="text" value="${values.getCategoryName()}"
													path="categoryName"
													style="border: 1px solid #ccc;
  font-size: 16px;
  height: 40px;
  ...
  width: 100%;" />
												<button class="aa-browse-btn" type="submit"
													style="color: black;">Edit Category</button>
											</form:form>
										</c:when>
										<c:otherwise>
											...
											<form:form action="${action}" method="get"
												...
												<label for="">Category Id:</label>
												<form:input type="text" placeholder="enter the category id"
													path="categoryId"
													style="border: 1px solid #ccc;
  font-size: 16px;
  height: 40px;
  ...
  width: 100%;" />
												...
												<label for="">Category Name:</label>
												<form:input type="text" placeholder="enter the suplier name"
													path="categoryName"
													style="border: 1px solid #ccc;
  font-size: 16px;
  height: 40px;
  ...
  width: 100%;" />
												<button class="aa-browse-btn" type="submit"
													style="color: black;">Add Category</button>
											</form:form>
