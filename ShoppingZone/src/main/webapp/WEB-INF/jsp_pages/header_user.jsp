                            ...
                            <div class="col-md-7 col-sm-10 hidden-xs">
                                <nav id="primary-menu">
                                    <ul class="main-menu">
                                        ...
                                        <li class="mega-parent pos-rltv"><a href="categorypage?categoryId=C01">CRICKET</a>
                                            
                                        </li>
                                        <li class="mega-parent pos-rltv"><a href="categorypage?categoryId=C02">BATMINTON</a>
                                            </li>
												<li class="mega-parent pos-rltv"><a href="categorypage?categoryId=C03">CYCLING</a>
                                            </li>
												<li class="mega-parent pos-rltv"><a href="categorypage?categoryId=C04">HOCKEY</a>
                                            
                                        </li>
										<li class="mega-parent pos-rltv"><a href="categorypage?categoryId=C05">FOOT BALL</a>
