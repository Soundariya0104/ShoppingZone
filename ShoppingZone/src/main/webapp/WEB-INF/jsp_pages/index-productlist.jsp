...
<body>
						...
						<div class="single-product">
							<div class="product-img">
								...
								<div class="product-icon socile-icon-tooltip text-center">
									<ul>
										<li><a
											href="cart?username=${User}&productId=${productList.productId}"
											data-tooltip="Add To Cart" class="add-cart"
							...
							<div class="product-img">
								<div class="single-prodcut-img  product-overlay pos-rltv">
									<a href="single-product.html"> <img alt=""
										src="<c:url value="/resources/images/product/03.jpg"/>">
									</a>
								</div>
								<div class="product-icon socile-icon-tooltip text-center">
									<ul>
										<li><a href="cart" data-tooltip="Add To Cart"
					...
					<div class="col-md-3">
						...
						<div class="single-product">
							<div class="product-img">
								<div class="single-prodcut-img  product-overlay pos-rltv">
									<a href="single-product.html"> <img alt=""
										src="<c:url value="/resources/images/product/02.jpg"/>">
									</a>
								</div>
								<div class="product-icon socile-icon-tooltip text-center">
									<ul>
					...
					<div class="col-md-3">
						...
						<div class="single-product">
							<div class="product-img">
								<div class="single-prodcut-img  product-overlay pos-rltv">
									<a href="single-product.html"> <img alt=""
										src="<c:url value="/resources/images/product/04.jpeg"/>">
									</a>
								</div>
								<div class="product-icon socile-icon-tooltip text-center">
									<ul>
					...
					<div class="col-md-3">
						...
						<div class="single-product">
							<div class="product-img">
								<div class="single-prodcut-img  product-overlay pos-rltv">
									<a href="single-product.html"> <img alt=""
										src="<c:url value="/resources/images/product/05.jpg"/>">
									</a>
								</div>
								<div class="product-icon socile-icon-tooltip text-center">
									<ul>
						...
						<div class="row">
							<div class="col-md-6 col-sm-6">
								<div class="sb-img text-center">
									<img src="<c:url value="/resources/images/banner/002.jpg"/>"
										alt="">
								</div>
							</div>
							<div class="col-md-6 col-sm-6">
				...
				<div class="col-md-6 col-sm-12 col-xs-12">
					<div class="single-banner gray-bg">
						<div class="row">
							<div class="col-md-6 col-sm-6">
								<div class="sb-img text-center">
									<img src="<c:url value="/resources/images/banner/001.jpeg"/>"
										alt="">
								</div>
							</div>
							<div class="col-md-6 col-sm-6">
						...
						<div class="col-md-12 text-center">
							<ul class="nav mb-40 heading-style-2" role="tablist">
								...
								<li role="presentation"><a href="#bestsellr"
									aria-controls="bestsellr" role="tab" data-toggle="tab">Best
										Seller</a></li>
								<li role="presentation"><a href="#specialoffer"
									aria-controls="specialoffer" role="tab" data-toggle="tab">Special
										Offer</a></li>
							</ul>
						</div>
					</div>
									...
									<div class="col-md-3">
										...
										<div class="single-product">
											<div class="product-img">
												...
												<div class="single-prodcut-img  product-overlay pos-rltv">
													<a href="single-product.html"> <img alt=""
														src="<c:url value="/resources/images/product/05.jpeg"/>">
													</a>
												</div>
												<div class="product-icon socile-icon-tooltip text-center">
													<ul>
														...
														<li><a href="#" data-tooltip="Compare" class="cpare"><i
																class="fa fa-refresh"></i></a></li>
														<li><a href="#" data-tooltip="Quick View"
															class="q-view" data-toggle="modal" data-target=".modal"><i
																class="fa fa-eye"></i></a></li>
													</ul>
												</div>
											</div>
									...
									<div class="col-md-3">
										...
										<div class="single-product">
											<div class="product-img">
												<div class="single-prodcut-img  product-overlay pos-rltv">
													<a href="single-product.html"> <img alt=""
														src="<c:url value="/resources/images/product/06.jpeg"/>">
													</a>
												</div>
												<div class="product-icon socile-icon-tooltip text-center">
													<ul>
									...
									<div class="col-md-3">
										...
										<div class="single-product">
											<div class="product-img">
												...
												<div class="single-prodcut-img  product-overlay pos-rltv">
													<a href="single-product.html"> <img alt=""
														src="<c:url value="/resources/images/product/07.jpg"/>">
													</a>
												</div>
												<div class="product-icon socile-icon-tooltip text-center">
													<ul>
									...
									<div class="col-md-3">
										...
										<div class="single-product">
											<div class="product-img">
												<div class="single-prodcut-img  product-overlay pos-rltv">
													<a href="single-product.html"> <img alt=""
														src="<c:url value="/resources/images/product/08.jpg"/>">
													</a>
												</div>
												<div class="product-icon socile-icon-tooltip text-center">
													<ul>
									...
									<div class="col-md-3">
										...
										<div class="single-product">
											<div class="product-img">
												<div class="single-prodcut-img  product-overlay pos-rltv">
													<a href="single-product.html"> <img alt=""
														src="<c:url value="/resources/images/product/09.jpeg"/>">
													</a>
												</div>
												<div class="product-icon socile-icon-tooltip text-center">
													<ul>
									...
									<div class="col-md-3">
										...
										<div class="single-product">
											<div class="product-img">
												...
												<div class="single-prodcut-img  product-overlay pos-rltv">
													<a href="single-product.html"> <img alt=""
														src="<c:url value="/resources/images/product/09.jpg"/>"></a>
												</div>
												<div class="product-icon socile-icon-tooltip text-center">
													<ul>
														<li><a href="cart" data-tooltip="Add To Cart"
									...
									<div class="col-md-3">
										...
										<div class="single-product">
											<div class="product-img">
												...
												<div class="single-prodcut-img  product-overlay pos-rltv">
													<a href="single-product.html"> <img alt=""
														src="<c:url value="/resources/images/product/10.jpg"/>">
													</a>
												</div>
												<div class="product-icon socile-icon-tooltip text-center">
													<ul>
									...
									<div class="col-md-3">
										...
										<div class="single-product">
											<div class="product-img">
												<div class="single-prodcut-img  product-overlay pos-rltv">
													<a href="single-product.html"> <img alt=""
														src="<c:url value="/resources/images/product/11.jpeg"/>">
													</a>
												</div>
												<div class="product-icon socile-icon-tooltip text-center">
													<ul>
									...
									<div class="col-md-3">
										...
										<div class="single-product">
											<div class="product-img">
												<div class="single-prodcut-img  product-overlay pos-rltv">
													<a href="single-product.html"> <img alt=""
														src="<c:url value="/resources/images/product/12.jpg"/>">
													</a>
												</div>
												<div class="product-icon socile-icon-tooltip text-center">
													<ul>
									...
									<div class="col-md-3">
										...
										<div class="single-product">
											<div class="product-img">
												<div class="single-prodcut-img  product-overlay pos-rltv">
													<a href="single-product.html"> <img alt=""
														src="<c:url value="/resources/images/product/13.jpeg"/>">
													</a>
												</div>
												<div class="product-icon socile-icon-tooltip text-center">
													<ul>
									...
									<div class="col-md-3">
										...
										<div class="single-product">
											<div class="product-img">
												<div class="single-prodcut-img  product-overlay pos-rltv">
													<a href="single-product.html"> <img alt=""
														src="<c:url value="/resources/images/product/14.jpeg"/>">
													</a>
												</div>
												<div class="product-icon socile-icon-tooltip text-center">
													<ul>
									...
									<div class="col-md-3">
										...
										<div class="single-product">
											<div class="product-img">
												...
												<div class="single-prodcut-img  product-overlay pos-rltv">
													<a href="single-product.html"> <img alt=""
														src="<c:url value="/resources/images/product/15.jpg"/>">
													</a>
												</div>
												<div class="product-icon socile-icon-tooltip text-center">
													<ul>
									...
									<div class="col-md-3">
										...
										<div class="single-product">
											<div class="product-img">
												<div class="single-prodcut-img  product-overlay pos-rltv">
													<a href="single-product.html"> <img alt=""
														src="<c:url value="/resources/images/product/16.jpeg"/>">
													</a>
												</div>
												<div class="product-icon socile-icon-tooltip text-center">
													<ul>
									...
									<div class="col-sm-6">
										<div class="product-ctg-img pos-rltv product-overlay">
											<a href="single-product.html"><img
												src="<c:url value="/resources/images/product/17.jpeg"/>"
												alt=""></a>
										</div>
									</div>
									<div class="col-sm-6">
							...
							<div class="single-ctg-item">
								<div class="row">
									<div class="col-sm-6">
										<div class="product-ctg-img pos-rltv product-overlay">
											<a href="single-product.html"><img
												src="<c:url value="/resources/images/product/18.jpg"/>"
												alt=""></a>
										</div>
									</div>
									<div class="col-sm-6">
							...
							<div class="single-ctg-item">
								<div class="row">
									<div class="col-sm-6">
										<div class="product-ctg-img pos-rltv product-overlay">
											<a href="single-product.html"><img
												src="<c:url value="/resources/images/product/19.jpeg"/>"
												alt=""></a>
										</div>
									</div>
									<div class="col-sm-6">
								...
								<div class="single-ctg-item">
									<div class="row">
										<div class="col-sm-6">
											<div class="product-ctg-img pos-rltv product-overlay">
												<a href="single-product.html"><img
													src="<c:url value="/resources/images/product/19.jpg"/>"
													alt=""></a>
											</div>
										</div>
										<div class="col-sm-6">
								...
								<div class="single-ctg-item">
									<div class="row">
										<div class="col-sm-6">
											<div class="product-ctg-img pos-rltv product-overlay">
												<a href="single-product.html"><img
													src="<c:url value="/resources/images/product/20.jpg"/>"
													alt=""></a>
											</div>
										</div>
										<div class="col-sm-6">
								...
								<div class="single-ctg-item">
									<div class="row">
										<div class="col-sm-6">
											<div class="product-ctg-img pos-rltv product-overlay">
												<a href="single-product.html"><img
													src="<c:url value="/resources/images/product/21.jpeg"/>"
													alt=""></a>
											</div>
										</div>
										<div class="col-sm-6">
								...
								<div class="single-ctg-item">
									<div class="row">
										<div class="col-sm-6">
											<div class="product-ctg-img pos-rltv product-overlay">
												<a href="single-product.html"><img
													src="<c:url value="/resources/images/product/20.jpeg"/>"
													alt=""></a>
											</div>
										</div>
										<div class="col-sm-6">
								...
								<div class="single-ctg-item">
									<div class="row">
										<div class="col-sm-6">
											<div class="product-ctg-img pos-rltv product-overlay">
												<a href="single-product.html"><img
													src="<c:url value="/resources/images/product/22.jpg"/>"
													alt=""></a>
											</div>
										</div>
										<div class="col-sm-6">
								...
								<div class="single-ctg-item">
									<div class="row">
										<div class="col-sm-6">
											<div class="product-ctg-img pos-rltv product-overlay">
												<a href="single-product.html"><img
													src="<c:url value="/resources/images/product/14.jpg"/>"
													alt=""></a>
											</div>
										</div>
										<div class="col-sm-6">
	...
	<div class="brand-area ptb-60">
		<h5 style="text-align: center; color: red">Our Popular Brands</h5>
		<br>
		<div class="container">
			<div class="row">
				<div class="total-brand">
					<div class="col-md-2">
						<div class="single-brand shadow-box">
							<a href="#"><img
								src="<c:url value="/resources/images/brand/01.png"/>" alt=""></a>
						</div>
					</div>
					<div class="col-md-2">
						<div class="single-brand shadow-box">
							<a href="#"><img
								src="<c:url value="/resources/images/brand/02.png"/>" alt=""></a>
						</div>
					</div>
					<div class="col-md-2">
						<div class="single-brand shadow-box">
							<a href="#"><img
								src="<c:url value="/resources/images/brand/03.png"/>" alt=""></a>
						</div>
					</div>
					<div class="col-md-2">
						<div class="single-brand shadow-box">
							<a href="#"><img
								src="<c:url value="/resources/images/brand/04.jpg"/>" alt=""></a>
						</div>
					</div>
					<div class="col-md-2">
						<div class="single-brand shadow-box">
							<a href="#"><img
								src="<c:url value="/resources/images/brand/05.jpg"/>" alt=""></a>
						</div>
					</div>
					<div class="col-md-2">
						<div class="single-brand shadow-box">
							<a href="#"><img
								src="<c:url value="/resources/images/brand/06.png"/>" alt=""></a>
						</div>
					</div>
