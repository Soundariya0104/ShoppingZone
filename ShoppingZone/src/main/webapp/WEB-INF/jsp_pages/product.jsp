...
<c:choose><c:when test="${ not empty values}">
  ...
  width: 50%;"/>
				       ...
				       <br> <label for="">Product Name:</label>
  ...
  width: 100%;"/>
					...
					<label for="">Category Id</label>
						<form:select path="categoryId" items="${categorylist}"  itemValue="categoryId" itemLabel="categoryId" style="border: 1px solid #ccc;
  font-size: 16px;
  height: 40px;
  margin-bottom: 15px;
  padding: 10px;
  width: 100%;" />
					...
					<form:select path="supplierId" items="${supplierlist}" itemValue="supplierId" itemLabel="supplierId" style="border: 1px solid #ccc;
  font-size: 16px;
  height: 40px;
  margin-bottom: 15px;
  padding: 10px;
  width: 100%;" />
   ...
   padding: 10px; 
   width: 100%;" /> 
 								<button class="aa-browse-btn" type="submit">Edit Product</button>
		</form:form>
  ...
  width: 100%;"/><br>
				...
				<label for="" style="width:49%">Category Id</label><br>
						<form:select path="categoryId" items="${categorylist}" itemValue="categoryId" itemLabel="categoryId"  style="border: 1px solid #ccc;
  font-size: 16px;
  height: 40px;
  margin-bottom: 15px;
  ...
  width: 47%;"/><br>
				         ...
				         <label for="">Supplier Id</label><br>
						<form:select path="supplierId" items="${supplierlist}" itemValue="supplierId" itemLabel="supplierId"  style="border: 1px solid #ccc;
  font-size: 16px;
  height: 40px;
  margin-bottom: 15px;
...
<label for="" style="width:49%">Product Price:</label>   
  ...
  width: 100%;"/><br>
   ...
   width: 100%;"/> 
								...
								<button class="aa-browse-btn" type="submit" style="color:black;">Add Product</button>
